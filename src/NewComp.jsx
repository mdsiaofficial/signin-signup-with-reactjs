...
export default function NewComp() {
  ...
  let s4 = `flex justify-center items-center w-[120px] h-[40px] text-white bg-header rounded-lg text-[20px] font-bold cursor-pointer`;
  let ss1 = (action === "Sign In") ? s4 + ` bg-gray-700 text-gray-400` : s4;
  let ss2 = (action === "Sign Up") ? s4 + ` bg-gray-700 text-gray-400` : s4;


  return (
    <div className="bg-indigo-700">
      <div className="flex flex-col m-auto mt-[200px] bg-white pb-[30px]">
        ...
        <div className={`mt-[20px] flex flex-col ${action === "Sign In" ? 'gap-[8px]' : 'gap-[25px]'}`}>
          {action === "Sign In" ?
            <div className="">
            </div> :
            <div className={s1}>
